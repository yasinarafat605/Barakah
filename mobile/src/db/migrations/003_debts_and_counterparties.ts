...
async function applyMigration003(db: DatabaseConnection): Promise<void> {
  ...
  // Step 2: Create debts table and indexes (v1: due_date INTEGER, status active|settled|archived)
  await db.execAsync(`
  ...
  // Step 3: Create debt_transactions ledger table and indexes (v1: role disbursement|repayment|adjustment)
  await db.execAsync(`
